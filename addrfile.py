...
def main(s):
    ...
    chunker = get_address_chunker('IOB_tagged_addresses.pkl')
##    print("Done.")
    ...
    #print(extract_address(chunker, "Hey man! Joe lives here: A602, Sachdev complex, Mumbai. Can you contact him now? If you need any help, call me on 12345678"))
    m=extract_address(chunker, s)
    m1=m[0]
    m2=' '.join(map(str,m1))
   ## print(m2)
    df.iat[0,10]= m2
    ...
    #print(extract_address(chunker, " hello! We need to discuss some issues about the upcoming event. Lets meet at Starbucks, Dadar, Mumbai"))
